...
2. status가 "relevant"일 때만:
   ...
   c. 후보 매뉴얼 중 사용자 입장(관점)과 "일치하는" 것만 최대 3개 골라 ID를 반환하세요.
      ★ 반드시 지킬 규칙 (위반 금지):
        - 상황의 "유형"이 실제로 일치해야 합니다. 신체폭력·학대 / 성폭력·성희롱 / 성매매 / 노동 / 금융 / 온라인폭력 등은 서로 다른 유형입니다.
          유형이 다르면(예: 신체적 학대인데 성매매·성폭력 매뉴얼을, 성희롱인데 임금·해고 매뉴얼을) 주제가 비슷해 보여도 절대 선택하지 마세요.
        - 피해자에게 "가해자 관점" 매뉴얼(예: "내가 친구를 때렸는데 처벌받나요")을, 가해자에게 "피해자 관점" 매뉴얼을 절대 선택하지 마세요.
